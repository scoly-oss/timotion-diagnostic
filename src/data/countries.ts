...
export const COUNTRIES: CountryData[] = [
  ...
  /* ─────── POLOGNE ─────── */
  {
    ...
    pension: {
      ...
      minimumPension: "1 878,91 PLN/mois brut (~€435/mois) — mars 2025",
      sources: [
  ...
  /* ─────── DANEMARK ─────── */
  {
    ...
    pension: {
      ...
      contributionRateEmployee: "ATP : 99 DKK/mois (1/3, montant fixe). Pension prof. : 2% du salaire via convention collective (depuis mai 2025).",
      contributionRateEmployer: "ATP : 198 DKK/mois (2/3, montant fixe). Pension prof. : 11% du salaire via convention collective (depuis mai 2025).",
      ...
      pillar1: "Folkepension : base ~6 978 DKK/mois + supplément sous conditions ~7 680 DKK/mois. ATP total : 297 DKK/mois (3 564 DKK/an).",
      pillar2: "Pensions professionnelles — QUASI-OBLIGATOIRES via conventions collectives (~90% couverts). Cotisation standard depuis mai 2025 : 13% du salaire (11% employeur + 2% salarié). Fonds : PensionDanmark, Danica, PFA.",
      pillar2Mandatory: false,
